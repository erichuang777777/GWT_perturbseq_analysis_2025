...
export function drawFigure(el: HTMLElement, S: AppState) {
  ...
  if (S.figureId === "volcano") {
    ...
    layout = base({ xaxis: { title: "Perturbation effect (|log2FC|)", zeroline: true, zerolinecolor: "#d6dbe3", gridcolor: "#eef0f3" }, yaxis: { title: "Lymphocyte-count LoF-burden β", zeroline: true, zerolinecolor: "#d6dbe3", gridcolor: "#eef0f3" } });
  }
