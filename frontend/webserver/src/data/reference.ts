...
export const FIGURES: Figure[] = [
  ...
  { id: "noveltyEffect", num: "N", title: "Novelty × effect quadrant", cat: "Prioritization", src: "evidence/external_cache.py (PubMed novelty) × target cards", desc: "Perturbation effect against PubMed novelty (higher = fewer papers). The upper-right quadrant — strong effect and understudied — is the highest-priority-to-test zone. Points appear only for genes with a measured literature count (the evidence cache; the rest are honestly absent, not plotted at zero). Descriptive prioritization view; never changes a readiness call." },
];
