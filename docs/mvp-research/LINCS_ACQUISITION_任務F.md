...
2. **標的覆蓋率：** shortlist 只有 **4/15** 有 LINCS signature：
   SENP5(24)、PLCG1(24)、CCNC(24)、PMVK(9)——全是 shRNA、癌症細胞株。
   **免疫候選 CD3E/LAT/CD247/VAV1 有 0 條 signature**（癌症細胞株不擾動這些基因）。
   → **LINCS 恰恰無法回答平台排名最高的那些標的。**
...
## 結論
LINCS 是**輔助性、假設生成**的交叉參考，且只對 4 個非免疫基因有效。
