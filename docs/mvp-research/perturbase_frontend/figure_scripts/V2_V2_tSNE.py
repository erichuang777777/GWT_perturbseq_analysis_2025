...
input-artifact version_ids:
  ...
  - df0cb26f-8ce1-40d1-a243-e0b66628a403
"""
...
Y_tsne = np.load('/Users/eric777/.claude-science/orgs/da569c35-fbb9-41f8-ad57-1225ad245b87/artifacts/proj_9efc9e969acb/34105139-310a-4bfa-870f-4f7331c68547/vdf0cb26f_Ytsne.npy')
...
plt.close('all')
f2 = embed_plot(Y_tsne, "t-SNE recovers response neighbourhoods that group curated targets", "t-SNE 1", "t-SNE 2", "V2_tSNE.png")