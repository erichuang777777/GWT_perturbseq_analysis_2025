"""
chart_id:        A16
source image:    Figure1_integrated_story.png
chart title:     Integrated Perturbation Analysis: Curation Pipeline and Context-Specific Target Effects
language:        Python
env name:        python
input-artifact version_ids (5):
  - 11c6348b-f46d-48a3-8c22-7ae328f40c6c  (DE_stats.suppl_table.csv)
  - a58b4ba0-da04-46b9-9ad2-21a3e632615c  (de_matrix.csv)
  - 71d9a85a-dde7-4ed5-8cf3-0d6dca0ebb9f  (panel_f.png)
  - 9a94572c-0dc9-48c2-8101-9afc9b9adfd8  (fig_outline.json)
  - 708d0974-d3ab-418f-bca4-9582069020dd  (panel_paths_v2.json)
packages referenced: PIL, host, json

NOTE: This is a multi-panel figure assembled with the figure-composer
compose_figure() helper (included verbatim below). The individual panels are
pre-rendered PNGs supplied as input artifacts (see panel_*.png above); their
per-panel plotting code is NOT in this artifact's lineage. Code is saved
verbatim and not fabricated. To tweak a single panel, edit the source cell
that produced that panel PNG, then re-run this composer.
"""
...
outline = json.load(open('/Users/eric777/.claude-science/orgs/da569c35-fbb9-41f8-ad57-1225ad245b87/artifacts/proj_9efc9e969acb/9dfe03d7-6068-43be-9f67-0c37c85c97d8/v9a94572c_fig_outline.json'))
paths = json.load(open('/Users/eric777/.claude-science/orgs/da569c35-fbb9-41f8-ad57-1225ad245b87/artifacts/proj_9efc9e969acb/09a7c2d3-492c-4399-884d-4c29efb1c6b8/v708d0974_panel_paths_v2.json'))

# panel e uses the already-fixed heatmap
paths["e"] = '/Users/eric777/.claude-science/orgs/da569c35-fbb9-41f8-ad57-1225ad245b87/artifacts/proj_9efc9e969acb/14eca17e-a6ab-45cd-a01c-2e305dd1123a/v71d9a85a_panel_f.png'

out_path, (W, H) = compose_figure(outline, paths, "Figure1_integrated_story.png", letter_pt=15)
print("最終合成:", out_path, f"{W}×{H}px, 字母 15pt bold")
