...
chart_id:        V1
source image:    V1_PCA.png
chart title:     PCA of CD4+ T-cell targets by mean effect magnitude
language:        Python
env name:        python
...
plt.close('all')
f1 = embed_plot(P[:, :2], "Curated targets separate from the target pool in response space", "PC1 (55%)", "PC2 (33%)", "V1_PCA.png")